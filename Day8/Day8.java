...
class Qus5
{
    public static void main(String[] args) throws CloneNotSupportedException 
	{
		...
		Person oObj = new Person("Dass", as);
...
class Qus7
{
	public static void main(String[] args)
	{
		StudentDetails sd1 = new StudentDetails(107, "Dass", 80.5);
		StudentDetails sd2 = new StudentDetails(102, "Renu", 90.2);
...
class Qus8
{
	public static void main(String[] args)
	{
		student s1 = new student("Dass", 105, "BSc");
